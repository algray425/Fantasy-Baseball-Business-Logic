...
{
    override fun getGrades(id: String, period: Period, startWeek: Int, endWeek: Int, season: Int, stats: List<BattingStat>): MutableList<HolisticBattingGrade>
    {
        return PlayerGradeSql.getAggregatePlayerGrades(id, startWeek, endWeek, season, stats)
    }
}