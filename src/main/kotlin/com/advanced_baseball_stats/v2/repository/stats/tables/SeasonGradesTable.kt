...
object SeasonGradesTable : Table<Nothing>("SeasonGrades")
{
    ...
    val hardHitPercentile = double("hardHitPercentile")
    val barrelPercentile = double("barrelPercentile")
    val babipPercentile = double("babipPercentile")
    val spdPercentile = double("spdPercentile")
    val laSweetSpotPercentile = double("laSweetSpotPercentile")
